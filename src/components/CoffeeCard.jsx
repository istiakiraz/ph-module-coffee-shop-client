...
const CoffeeCard = ({ coffeeData }) => {
  const [upCoffee, setUpCoffee] = useState(coffeeData);
  ...
  return (
    <div>
      <div className="text-center flex my-16 flex-col space-y-3 items-center">
        <h4>--- Sip & Savor ---</h4>
        <h2
          className="text-5xl mb-4 rancho"
          style={{
            textShadow:
        ...
        <Link to="/add-coffee">
          <button
            className="btn rancho border-2 border-[#331a15] text-white font-thin text-xl bg-[#E3B577] hover:bg-white hover:text-[#331a15] flex gap-2"
            style={{
              textShadow:
